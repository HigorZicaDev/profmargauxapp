                ...
                <!-- Modal body -->
                    ...
                    <div class="grid gap-4 mb-4 grid-cols-2 my-4 px-4">
                        ...
                        <div class="col-span-2 mb-6">
                            <a href="{{route('schedules.destroy', 1)}}" id="modal_details_delete" class="text-white inline-flex items-center justify-end bg-red-500 hover:bg-red-600 focus:ring-4 focus:outline-none focus:ring-red-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-red-500 dark:hover:bg-red-600 dark:focus:ring-red-800">
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            const openModalDetails = (info) => {
                ...
                if(modalDetails.classList.contains('hidden')){
                    ...
                    let valueHref = btnModalDelete.getAttribute("href"); 
                    const baseUrlDelete = valueHref.slice(0,valueHref.indexOf(1))
                    btnModalDelete.href = `${baseUrlDelete}${info.event.id}`
            ...
            const moveEvent = (info) => {
                ...
                let valueHrefUpdate = btnModalDelete.getAttribute("href"); 
                const baseUrlUpdate = valueHrefUpdate.slice(0,valueHrefUpdate.indexOf(1));

                var ajax = new XMLHttpRequest();
                var token = getCookie('XSRF-TOKEN');
                ajax.open('PUT', `${baseUrlUpdate}update/${info.event.id}`, false);
